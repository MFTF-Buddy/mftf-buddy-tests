...
use MFTFBuddy\Tests\Config\Dom\ValidationException;
...
class Dom
{
     ...
     * @param string $filename
     * @return \DOMDocument
     * @throws \MFTFBuddy\Tests\Config\Dom\ValidationException
     */
    protected function initDom($xml, $filename = null)
    {
        ...
        if ($this->schemaFile) {
            ...
            if (count($errors)) {
                throw new \MFTFBuddy\Tests\Config\Dom\ValidationException(implode("\n", $errors));
            }
        }
        return $dom;
    }
