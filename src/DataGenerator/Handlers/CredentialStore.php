...
namespace MFTFBuddy\Tests\DataGenerator\Handlers;

use MFTFBuddy\Tests\Exceptions\Collector\ExceptionCollector;
use MFTFBuddy\Tests\Exceptions\TestFrameworkException;
use MFTFBuddy\Tests\DataGenerator\Handlers\SecretStorage\BaseStorage;
use MFTFBuddy\Tests\DataGenerator\Handlers\SecretStorage\FileStorage;
use MFTFBuddy\Tests\DataGenerator\Handlers\SecretStorage\VaultStorage;
use MFTFBuddy\Tests\DataGenerator\Handlers\SecretStorage\AwsSecretsManagerStorage;
...
class CredentialStore
{
    ...
    {
        // Initialize vault storage
        $cvAddress = getenv('MB_CREDENTIAL_VAULT_ADDRESS');
        $cvSecretPath = getenv('MB_CREDENTIAL_VAULT_SECRET_BASE_PATH');
    ...
    {
        // Initialize AWS Secrets Manager storage
        $awsRegion = getenv('MB_CREDENTIAL_AWS_SECRETS_MANAGER_REGION');
        $awsProfile = getenv('MB_CREDENTIAL_AWS_SECRETS_MANAGER_PROFILE');
