...
use MFTFBuddy\Tests\DataGenerator\Util\DataExtensionUtil;
use MFTFBuddy\Tests\Util\Logger\LoggingUtil;
use MFTFBuddy\Tests\Util\Validation\NameValidationUtil;
...
class DataObjectHandler implements ObjectHandlerInterface
{
    ...
    /**
     * A collection of entity data objects that were seen in XML files and the .env_mb file
     *
