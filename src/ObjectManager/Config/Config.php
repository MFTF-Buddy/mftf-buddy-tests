...
use MFTFBuddy\Tests\ObjectManager\DefinitionInterface;
use MFTFBuddy\Tests\ObjectManager\RelationsInterface;
use MFTFBuddy\Tests\ObjectManager\Definition\Runtime as DefinitionRuntime;
use MFTFBuddy\Tests\ObjectManager\Relations\Runtime as RelationsRuntime;

/**
 * Class Config
 */
class Config implements \MFTFBuddy\Tests\ObjectManager\ConfigInterface
{
    /**
     * Class definitions
     *
