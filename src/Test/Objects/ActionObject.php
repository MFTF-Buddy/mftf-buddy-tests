 ...
 */
namespace MFTFBuddy\Tests\Test\Objects;

use MFTFBuddy\Tests\Config\MftfApplicationConfig;
use MFTFBuddy\Tests\DataGenerator\Handlers\DataObjectHandler;
use MFTFBuddy\Tests\DataGenerator\Objects\EntityDataObject;
use MFTFBuddy\Tests\Exceptions\XmlException;
use MFTFBuddy\Tests\ObjectManager\ObjectHandlerInterface;
use MFTFBuddy\Tests\Page\Objects\PageObject;
use MFTFBuddy\Tests\Page\Objects\SectionObject;
use MFTFBuddy\Tests\Page\Handlers\PageObjectHandler;
use MFTFBuddy\Tests\Page\Handlers\SectionObjectHandler;
use MFTFBuddy\Tests\Exceptions\TestReferenceException;
...
class ActionObject
{
    ...
    /**
     * Look up the url for SomePageName and set it, with MB_MAGENTO_BASE_URL prepended, as the url attribute in the
    ...
    private function resolveParameterization($isParameterized, $replacement, $match, $object)
    {
        ...
        if (get_class($object) === PageObject::class && $object->getArea() === PageObject::ADMIN_AREA) {
            $urlSegments = [
                '{{_ENV.MB_MAGENTO_BACKEND_BASE_URL}}',
                '{{_ENV.MB_MAGENTO_BACKEND_NAME}}',
                $resolvedReplacement
            ];
